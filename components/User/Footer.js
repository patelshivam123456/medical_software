    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:pt-2">
        <div class="sm:flex sm:items-center sm:justify-between px-4">
            <a href="/" class="mb-4 sm:mb-0 relative">
                ...
                <span class="absolute top-14 text-[8px] left-2 -pt-6  whitespace-nowrap text-white dark:text-white">ENTERPRISE</span>
            </a>
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="/" class="hover:underline">SHRI JI ENTERPRISE</a>. All Rights Reserved.</span>
    </div>
</footer>
