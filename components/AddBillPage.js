          ...
          {tablets.map((tab, index) => (
            <div key={index} className="border p-4 rounded mb-4">
              ...
              <div className="mb-2">
                ...
                <select
                  onChange={(e) => handleTabletChange(index, 'quantity', e.target.value)}
                  value={tab.quantity}
                  className="border p-2 w-full"
                >
                  {[1, 2, 3, 5, 10, 20].map((q) => (
              ...
              <div className="mb-2">
                ...
                <input
                  type="number"
                  value={tab.price}
                  onChange={(e) => handleTabletChange(index, 'price', e.target.value)}
                  className="border p-2 w-full"
                />
              </div>
              <div className="mb-2">
                ...
                <select
                  onChange={(e) => handleTabletChange(index, 'discount', e.target.value)}
                  value={tab.discount}
                  className="border p-2 w-full"
                >
                  {[0, 5, 10, 15, 20].map((d) => (
