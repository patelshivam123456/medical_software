        ...
        <div className="relative z-10 border px-2 py-2">
          <div className="flex">
            <div className="w-1/2">
              ...
              <div>Lucknow, Uttar Pradesh-226018</div>
              <div className="text-base">Mobile Number: +91-8736010763</div>
            </div>
            <div className="w-1/2">
              <div className="text-lg" style={{ fontWeight: "bold" }}>
